 ...
 */
@PatternInstance(name = "AbstractFactory", participants = { PhotoFactory.class, DrumPhotoFactory.class }
	//used to make the implementation of the specific PhotoFactory easy. 
)
